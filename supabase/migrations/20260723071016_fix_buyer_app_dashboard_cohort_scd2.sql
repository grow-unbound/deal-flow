-- cohort_members SCD2 fix: app.get_metrics_v2_buyer_app_dashboard's cohort-member count tile
-- must only count a buyer's currently-active cohort membership. Full function body
-- reproduced verbatim from
-- supabase/migrations/20260718142323_buyer_app_contribution_location_counts.sql with only
-- the cohort_members join patched (cm.valid_until IS NULL added).
