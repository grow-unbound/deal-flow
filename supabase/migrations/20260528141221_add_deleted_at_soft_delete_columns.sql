...
ALTER TABLE app.published_catalogs ADD COLUMN IF NOT EXISTS deleted_at timestamptz;
ALTER TABLE app.published_catalog_items ADD COLUMN IF NOT EXISTS deleted_at timestamptz;
