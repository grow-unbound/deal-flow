-- Fix KPI and callout calculation issues across locations, warehouses, and categories pages.
-- Addresses: 0 values, double counting, missing filters, wrong aggregation scopes.
