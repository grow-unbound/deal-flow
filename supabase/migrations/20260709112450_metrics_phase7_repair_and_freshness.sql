...
-- app.rebuild_metrics_for_tenant_range is defined (and owned) by
-- 20260712072733_fix_rebuild_metrics_for_tenant_range.sql — kept out of this
-- file to avoid two competing definitions of the same function in history.
