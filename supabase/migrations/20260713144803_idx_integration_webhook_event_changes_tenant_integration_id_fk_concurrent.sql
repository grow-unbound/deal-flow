...
-- app.integration_webhook_event_changes. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_webhook_event_changes_tenant_integration_id ON app.integration_webhook_event_changes (tenant_integration_id);
