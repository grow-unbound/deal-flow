...
-- app.integration_webhook_errors. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_webhook_errors_integration_webhook_id ON app.integration_webhook_errors (integration_webhook_id);
