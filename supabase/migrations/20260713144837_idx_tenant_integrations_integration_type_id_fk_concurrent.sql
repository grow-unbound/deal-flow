...
-- app.tenant_integrations. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tenant_integrations_integration_type_id ON app.tenant_integrations (integration_type_id);
