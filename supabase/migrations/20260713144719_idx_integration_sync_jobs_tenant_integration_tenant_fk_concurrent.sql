...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_sync_jobs_tenant_integration_tenant ON app.integration_sync_jobs (tenant_integration_id, tenant_id);
