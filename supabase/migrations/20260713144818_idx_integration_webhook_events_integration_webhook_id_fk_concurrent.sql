...
-- app.integration_webhook_events. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_webhook_events_integration_webhook_id ON app.integration_webhook_events (integration_webhook_id);
