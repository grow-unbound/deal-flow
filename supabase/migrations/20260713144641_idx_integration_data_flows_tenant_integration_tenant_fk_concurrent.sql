...
-- app.integration_data_flows. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_data_flows_tenant_integration_tenant ON app.integration_data_flows (tenant_integration_id, tenant_id);
