...
-- app.integration_entity_map. This table takes high write volume from the Zoho
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_entity_map_tenant_integration_tenant ON app.integration_entity_map (tenant_integration_id, tenant_id);
