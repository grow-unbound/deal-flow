...
function EmptyState() {
  return (
    ...
    >
      ...
      <p style={{ fontSize: 16, fontWeight: 600, color: 'var(--fg-1)', margin: '0 0 6px' }}>No orders yet</p>
      <p style={{ fontSize: 13, color: 'var(--fg-3)', margin: 0 }}>Your orders will appear here once placed.</p>
    </div>
  );
}
...
export function OrdersTab() {
  ...
  if (error) {
    return (
      ...
      >
        <p style={{ fontSize: 14, color: 'var(--danger-500)', margin: 0 }}>{error}</p>
      </div>
    );
  }
