      ...
      <div className="flex gap-3 px-4 py-3.5" style={grayedOut ? { opacity: 0.55 } : undefined}>
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-between py-0.5">
          <div className="min-w-0">
            <p className="truncate font-semibold leading-snug" style={{ fontSize: 'var(--b-text-label)', color: 'var(--fg-1, var(--cream-900))' }}>
              {item.name}
            </p>
            {subline ? (
...
export function BuyerDesktopCartDrawer({ open, onOpenChange }: BuyerDesktopCartDrawerProps) {
  ...
  function captureCartSubmitIntent(documentType: 'order' | 'estimate') {
  ...
  function captureCartSubmitFailed(documentType: 'order' | 'estimate', message: string) {
      ...
      >
        ...
        {confirmation ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 py-24 text-center">
            ...
            <div>
              <h2 className="mb-1 font-semibold" style={{ fontSize: 'var(--b-text-section)', fontFamily: 'var(--font-display)', fontWeight: 500, color: 'var(--fg-1, var(--cream-900))' }}>
                Your cart is empty
              </h2>
            ...
            <div className="flex-1 overflow-y-auto px-4 pt-4" style={{ paddingBottom: '8.5rem' }}>
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-[12px] px-4 py-3 text-left"
                  style={{
                ...
                >
                  <div className="flex shrink-0 items-center justify-center" style={{ width: 32, height: 32, borderRadius: 8, background: 'var(--ember-50)' }}>
                    <MapPin className="h-3.5 w-3.5" style={{ color: 'var(--ember-400)' }} />
                  </div>
                  <div className="min-w-0 flex-1">
                    {delivery?.selected ? (
                      <>
                        ...
                        <p className="truncate font-semibold" style={{ fontSize: 'var(--b-text-label)', color: 'var(--fg-1, var(--cream-900))' }}>
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    ...
                    <ChevronRight className="h-3 w-3" style={{ color: 'var(--teal-500)' }} />
                  </div>
                </button>
                ...
                {delivery?.selected?.selection_source === 'maps' && delivery.selected.routed_location_name ? (
                  <div className="flex items-start gap-2.5 rounded-[12px] px-4 py-3" style={{ background: 'var(--teal-50, #f0fdfa)', border: '1px solid var(--teal-100, #ccfbf1)' }}>
                    <MapPin className="mt-0.5 h-3.5 w-3.5 shrink-0" style={{ color: 'var(--teal-500)' }} />
        ...
        <AlertDialog open={oosConfirmOpen} onOpenChange={(nextOpen) => !isBusy && setOosConfirmOpen(nextOpen)}>
          <AlertDialogContent>
            <AlertDialogHeader>
