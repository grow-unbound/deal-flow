  ...
  if (linked.type === 'order') {
    return (
      <div className="px-5 py-4">
        ...
        <p className="mt-1 pl-7 text-sm text-cream-700">
  ...
  if (linked.type === 'estimate') {
    ...
    return (
      <div className="px-5 py-4">
        ...
        <p className="mt-1 pl-7 text-sm text-cream-700">Converted directly from estimate</p>
      </div>
    );
  }
  return (
    <div className="px-5 py-4">
      <div className="flex items-start gap-3 text-base font-semibold text-cream-900">
        <PlusCircle className="mt-0.5 h-4 w-4 shrink-0 text-cream-600" aria-hidden />
        <span>Direct invoice</span>
      </div>
      <p className="mt-1 pl-7 text-sm text-cream-700">Created directly — no linked SO or estimate</p>
    </div>
  );
}
