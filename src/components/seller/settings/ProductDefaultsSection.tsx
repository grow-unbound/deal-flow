...
import { UOM_OPTIONS } from '@/constants/settings-modules';
...
export function ProductDefaultsSection({ value, onChange, className }: ProductDefaultsSectionProps) {
  return (
    <SettingsSectionCard
      className={className}
      ...
      footer={
        <div className="flex items-start gap-2 text-base text-cream-700">
          ...
          <span>
            ...
            . Default GST rate lives under General → Business Policy.
          </span>
        </div>
      }
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <p className="text-sm text-cream-600">How you typically sell — can be changed per category.</p>
        </div>
      </div>
    </SettingsSectionCard>
  );
