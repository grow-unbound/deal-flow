...
export function ProductActivityTimeline({ activity }: ProductActivityTimelineProps) {
  ...
  return (
    <section className="mt-5 rounded-[14px] border border-cream-300 bg-white p-5">
      ...
      <p className="mt-1 text-[13px] text-cream-700">Chronological changes related to this product</p>
      <div className="mt-4 space-y-6">
        ...
        {activity.length === 0 ? (
          <div className="rounded-[10px] border border-cream-200 bg-cream-50 px-5 py-8 text-center text-[13px] text-cream-700">
