...
function renderAvatar(avatar: DetailAvatar) {
  ...
  if (avatar.kind === 'catalog') {
    return (
      <div className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-[14px] border border-ember-200 bg-ember-100 font-display text-[16px] font-semibold uppercase text-ember-800">
        {avatar.initials ?? 'CT'}
      </div>
    );
  }
