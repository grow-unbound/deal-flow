...
const CONFIG = {
  order: { table: 'orders', number: 'order_number', date: 'placed_at', amount: 'total_amount', items: 'order_items', parent: 'order_id', extra: 'campaign_id, source, is_buyer_app_order' },
