  ...
  return (
    <div className="mx-auto w-full max-w-[1920px] space-y-5 px-8 py-6" role="status" aria-label="Loading warehouses">
      <div className="space-y-3">
        <div className="h-7 w-40 animate-pulse rounded bg-cream-200" />
      ...
      <div className="overflow-hidden rounded-[14px] border border-cream-300 bg-white">
        <div className="grid grid-cols-[1.8fr_1.1fr_1fr_0.8fr_0.9fr_0.8fr_0.9fr_0.9fr_40px] gap-3 border-b border-cream-200 px-5 py-3">
        ...
        <div className="space-y-3 p-4">
          {Array.from({ length: 6 }).map((_, row) => (
            <div key={row} className="grid grid-cols-[1.8fr_1.1fr_1fr_0.8fr_0.9fr_0.8fr_0.9fr_0.9fr_40px] gap-3">
