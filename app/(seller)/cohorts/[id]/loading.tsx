// Mirrors cohort detail: breadcrumb, title row, 4 KPIs, 2 tabs, content panel
export default function CohortDetailLoading() {
  return (
    <div className="max-w-[1920px] mx-auto w-full px-8 pt-7 pb-6 space-y-6" role="status" aria-label="Loading cohort detail">
      <div className="space-y-3">
        <div className="h-4 w-52 animate-pulse rounded bg-cream-200" />
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 shrink-0 animate-pulse rounded-full border border-cream-200 bg-cream-100" />
            <div className="space-y-2">
              <div className="h-7 w-56 animate-pulse rounded bg-cream-200" />
              <div className="h-4 w-80 animate-pulse rounded bg-cream-200" />
            </div>
          </div>
          <div className="h-9 w-[8.5rem] animate-pulse rounded-[8px] bg-cream-200" />
        </div>
      </div>
