...
import { useCohortsLanding, type CohortType, type CohortsLandingRow } from '@/hooks/useCohorts';
...
function CohortsLandingContent() {
  ...
  const { data, isLoading, isError, refetch } = useCohortsLanding();
