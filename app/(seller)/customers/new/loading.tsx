// Mirrors new customer form shell
export default function NewCustomerLoading() {
  return (
    <div className="max-w-[1920px] mx-auto w-full px-8 py-6 space-y-6" role="status" aria-label="Loading new customer">
      <div className="h-8 w-44 animate-pulse rounded-md bg-cream-200" />
