...
import { usePriceListsLanding, type PriceListLandingRow } from '@/hooks/usePriceLists';
...
function PriceListsLandingContent() {
  ...
  const { data, isLoading, isError, refetch } = usePriceListsLanding();
