// Structural match for price list detail: breadcrumb → header → KPIs → tab → filters card → toolbar → table rows.
export default function PriceListDetailLoading() {
  return (
    <div
      className="max-w-[1920px] mx-auto w-full px-8 pt-7 pb-10 space-y-6"
      role="status"
