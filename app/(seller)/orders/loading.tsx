export default function OrdersLoading() {
  return (
    <div className="px-8 py-6" role="status" aria-label="Loading orders page">
      ...
      <div className="mt-0 overflow-hidden rounded-b-[14px] border border-cream-300 border-t-0 bg-white">
