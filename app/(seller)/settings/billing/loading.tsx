    ...
    <div className={WRAP}>
      ...
      <div className="overflow-hidden rounded-xl border border-cream-200 bg-cream-100">
        ...
        <div className="space-y-4 px-5 py-5">
          <div className="h-24 animate-pulse rounded-lg border border-cream-200 bg-cream-100" />
        </div>
      </div>

      <div className="h-28 animate-pulse rounded-xl border border-cream-200 bg-cream-100" />
