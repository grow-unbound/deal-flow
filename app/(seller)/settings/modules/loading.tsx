export default function SettingsModulesLoading() {
  return (
    <div
      className="mx-auto w-full max-w-[1920px] space-y-6 px-8 py-6"
      role="status"
      aria-label="Loading feature modules"
    >
      <div className="space-y-2">
        <div className="h-4 w-24 animate-pulse rounded bg-cream-200" />
        <div className="h-9 w-64 max-w-full animate-pulse rounded bg-cream-200" />
        <div className="h-4 w-full max-w-xl animate-pulse rounded bg-cream-200" />
      </div>

      <div className="grid gap-6 lg:grid-cols-2">
        <div className="overflow-hidden rounded-xl border border-cream-200 bg-cream-100">
      ...
      {[1, 2].map((i) => (
        <div key={i} className="overflow-hidden rounded-xl border border-cream-200 bg-cream-100">
          <div className="flex gap-3 border-b border-cream-200 bg-cream-100 px-5 py-4">
            <div className="h-10 w-10 shrink-0 animate-pulse rounded-[10px] bg-cream-200" />
            <div className="min-w-0 flex-1 space-y-2">
              <div className="h-4 w-48 animate-pulse rounded bg-cream-200" />
