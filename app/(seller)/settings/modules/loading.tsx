export default function SettingsModulesLoading() {
  return (
    <div className="max-w-[1920px] mx-auto w-full px-8 py-6 space-y-6" role="status" aria-label="Loading feature modules">
      ...
      <div className="max-w-[740px] overflow-hidden rounded-xl border border-cream-100 bg-white shadow-xs">
      ...
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="max-w-[740px] overflow-hidden rounded-xl border border-cream-100 bg-white shadow-xs"
        >
          <div className="flex gap-3 border-b border-cream-200 bg-cream-50 px-5 py-4">
          ...
          <div className="space-y-0 px-0 py-0">
            <div className="h-16 animate-pulse border-b border-cream-100 bg-cream-50/50" />
            <div className="h-16 animate-pulse border-b border-cream-100 bg-cream-50/50" />
            <div className="h-16 animate-pulse bg-cream-50/50" />
          </div>
        </div>
      ))}
      {/* Save bar */}
