// Mirrors ProductLandingSkeleton in src/components/seller/products/ProductsLandingClient.tsx
export default function ProductsLoading() {
  return (
    <div className="max-w-[1920px] mx-auto w-full px-8 py-6 space-y-5" role="status" aria-label="Loading products">
