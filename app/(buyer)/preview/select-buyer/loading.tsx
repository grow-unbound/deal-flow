export default function Loading() {
  return (
    <div className="flex min-h-full items-center justify-center p-4">
      <div className="w-full max-w-md space-y-4 rounded-[12px] border border-cream-200 bg-[var(--bg-surface)] p-6">
        ...
        <div className="h-16 animate-pulse rounded-[12px] bg-cream-100" />
        <div className="h-16 animate-pulse rounded-[12px] bg-cream-100" />
      </div>
    </div>
  );
